...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MdesDigitalEnablementApi.TokenForGetToken = factory(root.MdesDigitalEnablementApi.ApiClient, root.MdesDigitalEnablementApi.ProductConfig, root.MdesDigitalEnablementApi.TokenInfoForNTUAndGetToken);
  }
  ...
  /**
   * The TokenForGetToken model module.
   * @module model/TokenForGetToken
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>TokenForGetToken</code>.
   * @alias module:model/TokenForGetToken
   * @class
   */
  ...
  /**
   * Constructs a <code>TokenForGetToken</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TokenForGetToken} obj Optional instance to populate.
   * @return {module:model/TokenForGetToken} The populated <code>TokenForGetToken</code> instance.
   */
