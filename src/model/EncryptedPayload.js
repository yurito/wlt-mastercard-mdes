...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MdesDigitalEnablementApi.EncryptedPayload = factory(root.MdesDigitalEnablementApi.ApiClient, root.MdesDigitalEnablementApi.NotifyTokenEncryptedPayload);
  }
   ...
   * @class
   * @param publicKeyFingerprint {String} The fingerprint of the public key used to encrypt the ephemeral AES key. 
   * @param encryptedKey {String} One-time use AES key encrypted by the MasterCard public key (as identified by publicKeyFingerprint) using the OAEP or PKCS#1 v1.5 scheme (depending on the value of oaepHashingAlgorithm. 
