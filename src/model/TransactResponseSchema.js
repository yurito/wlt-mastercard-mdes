...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EncryptedPayloadTransact'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EncryptedPayloadTransact'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesDigitalEnablementApi) {
      root.MdesDigitalEnablementApi = {};
    }
    root.MdesDigitalEnablementApi.TransactResponseSchema = factory(root.MdesDigitalEnablementApi.ApiClient, root.MdesDigitalEnablementApi.EncryptedPayloadTransact);
  }
}(this, function(ApiClient, EncryptedPayloadTransact) {
  'use strict';
