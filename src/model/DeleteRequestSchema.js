...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MdesDigitalEnablementApi.DeleteRequestSchema = factory(root.MdesDigitalEnablementApi.ApiClient);
  }
   ...
   * @param causedBy {String} Who or what caused the Token to be deleted. Must be either the 'CARDHOLDER' (operation requested by the Cardholder) or 'TOKEN_REQUESTOR' (operation requested by the token requestor). 
   * @param reasonCode {String} The reason for the action to be deleted. Must be one of 'SUSPECTED_FRAUD' (suspected fraudulent token transactions), 'OTHER' (Other - default used if value not provided). 
   */
