...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TokenDetailDataPAROnly'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TokenDetailDataPAROnly'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesDigitalEnablementApi) {
      root.MdesDigitalEnablementApi = {};
    }
    root.MdesDigitalEnablementApi.TokenDetailPAROnly = factory(root.MdesDigitalEnablementApi.ApiClient, root.MdesDigitalEnablementApi.TokenDetailDataPAROnly);
  }
}(this, function(ApiClient, TokenDetailDataPAROnly) {
  'use strict';
