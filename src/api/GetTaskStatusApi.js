...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorsResponse', 'model/GatewayErrorsResponse', 'model/GetTaskStatusRequestSchema', 'model/GetTaskStatusResponseSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorsResponse'), require('../model/GatewayErrorsResponse'), require('../model/GetTaskStatusRequestSchema'), require('../model/GetTaskStatusResponseSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesDigitalEnablementApi) {
      root.MdesDigitalEnablementApi = {};
    }
    root.MdesDigitalEnablementApi.GetTaskStatusApi = factory(root.MdesDigitalEnablementApi.ApiClient, root.MdesDigitalEnablementApi.ErrorsResponse, root.MdesDigitalEnablementApi.GatewayErrorsResponse, root.MdesDigitalEnablementApi.GetTaskStatusRequestSchema, root.MdesDigitalEnablementApi.GetTaskStatusResponseSchema);
  }
}(this, function(ApiClient, ErrorsResponse, GatewayErrorsResponse, GetTaskStatusRequestSchema, GetTaskStatusResponseSchema) {
  'use strict';
